...
namespace GovConnect.Data.Migrations
{
    ...
    [Migration("20250930224317_AddPriorityLevelEntity")]
    partial class AddPriorityLevelEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GovConnect.Data.Entities.Request", b =>
                {
                    ...
                    b.HasOne("GovConnect.Data.Entities.PriorityLevel", "PriorityLevel")
                        .WithOne("Request")
                        .HasForeignKey("GovConnect.Data.Entities.Request", "PriorityLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
